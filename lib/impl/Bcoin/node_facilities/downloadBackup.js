...
function downloadBackup(_) {
    ...
    return dl(baseFileUrl + "_md5", baseSaveTo + "_md5").then(function () { return dl(baseFileUrl, "" + baseSaveTo); }).then(function () {
        return checkBackupFileMD5({
...
function checkBackupFileMD5(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, Promise.all([util_1.promisify(fs_2.readFile)(checksumFile, 'utf8'), util_1.promisify(md5File)(backupFile)])];
                case 1:
