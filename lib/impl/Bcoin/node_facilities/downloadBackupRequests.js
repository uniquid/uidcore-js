...
function downloadBackups(_a) {
    var blockNumber = _a.blockNumber, _b = _a.network, network = _b === void 0 ? 'testnet' : _b, host = _a.host;
    var names = getBackupFilenames({
        blockNumber: blockNumber,
        network: network,
        host: host
    });
    return {
        db: request_1.default(names.dbFileUrl),
        md5: request_1.default(names.md5FileUrl)
    };
}
exports.downloadBackups = downloadBackups;
function getBackupFilenames(_a) {
    var blockNumber = _a.blockNumber, _b = _a.network, network = _b === void 0 ? 'testnet' : _b, host = _a.host;
    var dbFileUrl;
    var md5FileUrl;
...
//# sourceMappingURL=downloadBackupRequests.js.map