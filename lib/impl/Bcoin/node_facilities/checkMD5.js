...
function checkBackupFileMD5(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, Promise.all([util_1.promisify(fs_1.readFile)(checksumFile, 'utf8'), util_1.promisify(md5_file_1.default)(backupFile)])];
                case 1:
                    _b = _c.sent(), md5 = _b[0], hash = _b[1];
                    return [2 /*return*/, md5 === hash];
            }
        });
    });
}
exports.checkBackupFileMD5 = checkBackupFileMD5;
//# sourceMappingURL=checkMD5.js.map