...
exports.signMessage = function (bip32ExtMasterPrivateKey) { return function (message, abstractIdentity) {
    var messagePrefix = buffer_1.Buffer.from('\u0019Litecoin Signed Message:\n', 'utf8');
    ...
    var sigObj = secp256k1.sign(hs, derivedPK);
    // tslint:disable-next-line:no-magic-numbers
    sigObj.recovery += 4;
    // tslint:disable-next-line:no-magic-numbers
    var _tsSigned = buffer_1.Buffer.concat([buffer_1.Buffer.alloc(1, sigObj.recovery + 27), sigObj.signature]);
    return _tsSigned;
}; };
