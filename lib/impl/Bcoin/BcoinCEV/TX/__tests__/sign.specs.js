        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, BcoinID_1.makeBcoinID({ home: path.join(__dirname, 'sign_home_test_1'), network: 'uqregtest' })];
                case 1:
                    id = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ;
                    paths = ['0/0/0'].map(function (p) { return p.split('/'); });
                    return [4 /*yield*/, BcoinID_1.makeBcoinID({ home: path.join(__dirname, 'sign_home_test_2'), network: 'uqregtest' })];
                case 1:
                    id = _a.sent();
                    result = sign_1.transactionSigner(id, unsignedRawTX, paths);
                    expect(result.txid).toEqual(expected);
