...
exports.getRoleContracts = function (identities, rawBcoinTxs) {
    return rawBcoinTxs.filter(exports.isContractTX()).reduce(function (contracts, tx) {
        var identity = identities.find(function (id) { return id.address === exports.getProviderAddress(tx) || id.address === exports.getUserAddress(tx); });
        if (identity) {
...
exports.getRevokingAddresses = function (revokingAddresses, rawBcoinTxs) {
    ...
    return revokingAddresses.filter(function (revokingAddress) { return txInputAddresses.includes(revokingAddress); });
};
