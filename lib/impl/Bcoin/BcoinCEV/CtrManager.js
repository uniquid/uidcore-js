...
var loopRoleContractWatch = function (db, pool, id, watchahead, onContracts) { return __awaiter(_this, void 0, void 0, function () {
    var nextWatchIdentities, nextWatchAddresses, watchingRevokingAddresses, txs, newContracts, revokingAddresses;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                nextWatchIdentities = [db.getLastProviderContractIdentity(), db.getLastUserContractIdentity()]
                ...
                console.log("watchingRevokingAddresses: ", watchingRevokingAddresses.reduce(function (s, a, i) { return s + "\n" + i + " : " + a; }, ''));
                console.log("nextWatchAddresses: ", nextWatchAddresses.reduce(function (s, a, i) { return s + "\n" + i + " : " + a; }, ''));
            ...
            case 1:
                ...
                console.log(newContracts.reduce(function (s, c) { return "" + s + c.identity.role + "[" + c.identity.index + "] -> " + c.contractor + "\n"; }, ''));
                ...
                console.log(revokingAddresses.reduce(function (s, a) { return "" + s + a + "\n"; }, ''));
                revokingAddresses.forEach(db.revokeContract);
                onContracts(newContracts, revokingAddresses);
                loopRoleContractWatch(db, pool, id, watchahead, onContracts).catch(function (err) {
                    return console.error('loopRoleContractWatch ERROR:', err);
                });
                return [2 /*return*/];
        }
    });
}); };
var ensureImprinting = function (db, id, pool) { return __awaiter(_this, void 0, void 0, function () {
...
var ensureOrchestration = function (db, id, pool) { return function (imprintingContract) { return __awaiter(_this, void 0, void 0, function () {
...
var providerNameProcess = function (db, providerNameResolver) {
    ...
    function next() {
        ...
        if (contract) {
            var cacheList_1 = contractsWithUnresolvedProviderNames;
            ...
            providerNameResolver(providerAddress_1)
                ...
                cacheList_1.push(contract);
            })
                .then(function () { return (cacheList_1 === contractsWithUnresolvedProviderNames ? next() : void 0); })
                .catch(console.error);
        }
    }
};
 ...
 */
exports.startContractManager = function (db, id, pool, watchahead, providerNameResolver) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, ensureImprinting(db, id, pool).then(ensureOrchestration(db, id, pool)).then(function () {
                var trigger = providerNameProcess(db, providerNameResolver).trigger;
                loopRoleContractWatch(db, pool, id, watchahead, trigger).catch(function (err) {
                    return console.error('loopRoleContractWatch ERROR:', err);
                });
                trigger();
            })];
