...
exports.Pool = function (options) { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
    var chainLogger, poolLogger, chain, pool, unlock, resolve, txs, watchAddresses, scheduledResponse, listener, broadcast;
            ...
            case 4:
                ...
                listener = function (block, entry) {
                    ...
                    if (block.txs.length && !scheduledResponse) {
                        console.log("*BLOCK with txs: " + block.toJSON().hash, block.txs.map(function (tx) { return tx.toJSON().hash; }), "waits " + WATCHADDRESS_WAIT_BEFORE_RESPONSE);
                        unlock = pool.locker.lock();
