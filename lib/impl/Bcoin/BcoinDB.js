...
exports.makeBcoinDB = function (options) {
    return new Promise(function (resolve, reject) {
        ...
        function autoloadCallback() {
            ...
            var getAllRoleContracts = function () {
                return contracts.find({
                    orchestration: { $ne: true },
                    imprinting: { $ne: true }
                });
            ...
            var getAllUserContracts = function () {
                return contracts.find({
                    'identity.role': Identity_1.Role.User,
                    orchestration: { $ne: true },
                    imprinting: { $ne: true }
            ...
            var getAllProviderContracts = function () {
                return contracts.find({
                    'identity.role': Identity_1.Role.Provider,
                    orchestration: { $ne: true },
                    imprinting: { $ne: true }
            ...
            var bcoinDB = {
                getAllRoleContracts: getAllRoleContracts,
                getAllUserContracts: getAllUserContracts,
                getAllProviderContracts: getAllProviderContracts,
