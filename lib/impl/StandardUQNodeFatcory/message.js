        ...
        _request &&
            ...
            rpc
                ...
                if (resp.hasOwnProperty('requester') && resp.hasOwnProperty('signature')) {
                    // tslint:disable-next-line:no-floating-promises
                    publish({ topic: resp.requester, data: resp });
                }
                else {
                    // tslint:disable-next-line:no-floating-promises
                    publish({ topic: _request.sender, data: resp });
                }
            })
