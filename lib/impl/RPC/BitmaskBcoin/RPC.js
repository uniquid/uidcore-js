...
var manageRequest = function (db, id, handlers) { return function (request) {
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var _a, method, params, js, valid, current, offset, _sender, contract, error, result, handler, err_1, response, jsresp, sjson;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    offset = 60000;
                    if (!(valid && (request.body.id <= current + offset && request.body.id >= current - offset))) return [3 /*break*/, 11];
