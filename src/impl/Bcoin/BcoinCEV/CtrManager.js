    ...
    function next() {
        ...
        if (contract) {
            ...
            providerNameResolver(providerAddress_1)
                .then(function (providerName) { return db.setProviderName(providerAddress_1, providerName); })["catch"](function (error) {
                console.error("ProviderNameResolver [" + providerAddress_1 + "] Error", error);
