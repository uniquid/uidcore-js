...
exports.makeBcoinCEV = function (db, id, options) {
    ...
    poolPromise
        .then(function (pool) { return CtrManager_1.startContractManager(db, id, pool, options.watchahead, options.providerNameResolver); })["catch"](function (err) { return console.log('makeBcoinCEV ERROR', err); });
