...
exports.messages = function (_a) {
    var announceMessage = _a.announceMessage, mqttHost = _a.mqttHost, rpc = _a.rpc, rpcHandlers = _a.rpcHandlers, requestTimeout = _a.requestTimeout;
    ...
    client.on('connect', function () {
        ...
        publish(announceMessage)["catch"](function (err) { return console.error('Publish Announce Error:', err); });
    });
    client.on('message', function (topic, messageBuf) {
        ...
        _request &&
            ...
            rpc
                ...
                .then(function (resp) { return publish({ topic: _request.sender, data: resp }); })["catch"](function (err) { return console.error('Request Message Error:', err); });
    });
