...
const masterPrivKey = 'tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK';
describe('HD keys derivation', () => {
    ...
    it('signs hash for an AbstractIdentity', () => {
        ...
        const masterPrivKeyForSign = 'tprv8ZgxMBicQKsPdoj3tQG8Z2bzNsCTsk9heayJQA1pQStVx2hLEyVwx6gfHZ2p4dSzbvaEw7qrDXnX54vTVbkLghZcB24TXuj1ADXPUCvyfcy';
        // prettier-ignore
        ...
        // tslint:disable-next-line:no-magic-numbers
        const result = HD_1.signFor(masterPrivKeyForSign)(abstrId, hash, false);
